<template>
  <div class="grid grid-cols-3 gap-4">
    <div
      class="h-screen bg-cover bg-center col-span-2"
      style="
        background-image: url('https://images.unsplash.com/photo-1547245324-d777c6f05e80?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80');
      "
    ></div>
      ...
      <div class="grid grid-cols-1 gap-4 content-center m-auto">
        ...
        <form action="" method="post">
          ...
          <div class="flex items-center mb-3">
            ...
            />
            <label for="default-checkbox" class="ml-2 text-sm font-medium dark:text-black"
              >Show Password</label
            >
          </div>
          <div class="mb-3">
            ...
            <a href="/login">
              <button
                type="button"
                class="w-full py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
              >
                Back
              </button>
            </a>
