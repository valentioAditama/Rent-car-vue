<template>
  <section
    class="bg-center bg-cover bg-[url('https://images.unsplash.com/photo-1587580945215-5d4aabb2c8ef?auto=format&fit=crop&q=80&w=1414&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-gray-700 bg-blend-multiply"
  >
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
      ...
      <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
        Services Rent car trusted Number 1 in indonesia
      </p>
